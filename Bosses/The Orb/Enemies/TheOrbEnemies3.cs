...
public class TheOrbEnemies3 : StateMachineBehaviour {
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        ...
        for (int i = 0; i < 2; i++)  {
            ...
            main.currentEnemies[i] = Instantiate(Enemy, main.enemyPositions[i].position, main.enemyPositions[i].transform.rotation);
            linePositions[i] = main.currentEnemies[i].transform.GetChild(0);
